...
{
    private const string migrationProjectPrefix = "EventPad.Pay.Context.Migrations.";

    public static DbContextOptions<PayDbContext> Create(string connStr, DbType dbType, bool detailedLogging = false)
    {
        var builder = new DbContextOptionsBuilder<PayDbContext>();
